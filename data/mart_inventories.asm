...
; Viridian
ViridianCashierText::
	TX_MART GREAT_BALL, ANTIDOTE, PARLYZ_HEAL, BURN_HEAL

; Pewter
PewterCashierText::
	TX_MART GREAT_BALL, POTION, ESCAPE_ROPE, ANTIDOTE, BURN_HEAL, AWAKENING, PARLYZ_HEAL

; Cerulean
CeruleanCashierText::
	TX_MART GREAT_BALL, POTION, REPEL, ANTIDOTE, BURN_HEAL, AWAKENING, PARLYZ_HEAL
...
VermilionCashierText::
	TX_MART GREAT_BALL, SUPER_POTION, ICE_HEAL, AWAKENING, PARLYZ_HEAL, REPEL
...
CeladonMart2Clerk1Text::
	TX_MART GREAT_BALL, BERRY, SUPER_POTION, REVIVE, SUPER_REPEL, ANTIDOTE, BURN_HEAL, ICE_HEAL, AWAKENING, PARLYZ_HEAL
...
; Fuchsia
FuchsiaCashierText::
	TX_MART GREAT_BALL, SUPER_POTION, REVIVE, FULL_HEAL, SUPER_REPEL
...
; Indigo
IndigoCashierText::
	TX_MART GREAT_BALL, FULL_RESTORE, MAX_POTION, FULL_HEAL, REVIVE, MAX_REPEL
